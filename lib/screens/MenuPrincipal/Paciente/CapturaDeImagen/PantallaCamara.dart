...
class _PantallaCamaraState extends State<PantallaCamara> {
  ...
  @override
  void dispose() {
    //Esta funcion se ocupa para liberar recursos de que ya no se usan,por ejemplo, la conexion con el hardware de la camara
    _cameraController?.dispose();
    super.dispose();
  }

  Future<void> _openCamera() async {
    //Funcion asincrona, que se acompletara con o sin exito en un futuro,la cual  no devolvera ningun valor.
    ...
    if (status.isGranted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Permisos de la cámara DENEGADOS")),
      );
    }
  }
  ...
  Future<void> _captureImage() async {
    ...
    if (_cameraController != null && _isCameraInitialized) {
      //En esta condicion,nos indica que en el caso de que la variable _cameraController sea diferente de nulo y ademas de que la variable _isCameraInitialized sea verdadera, hara lo siguente
      try {
        //Dentro de un try-catch, se guardara en un variable, la captura que el usuario tome con la camara.
